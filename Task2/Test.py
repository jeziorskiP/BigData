...
"""
#warehouse = user_friends.collect()
sample1 = user_friends.take(10)
print("Po sample")
print(sample1)
print("user_friendsENDDDDDDDDDDDDDDDDDDd")
"""
...
print("pairs_from_commonFriend")
sam1 = pairs_from_commonFriend.take(5)
print(sam1)
...
print("pairs_CntOf_commonFriends")
sam2 = pairs_CntOf_commonFriends.take(5)
print(sam2)
...
print("pairs_hasCommon_yetFriends")
sam4 = pairs_hasCommon_yetFriends.take(5)
print(sam4)
...
print("user_recommendList_byShareCnt")
...
print("recommendList_byShareCnt")
sam5 = recommendList_byShareCnt.take(5)
print(sam5)
